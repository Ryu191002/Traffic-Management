...
ap.add_argument("-u","--username",required=True,
	help="username to mail output")
args = vars(ap.parse_args())

classname = []
list_of_vehicles = ["bicycle","car","motorbike"]
...
list_of_vehicles = ["car","motorbike","bicycle"]
...
timer=truck*1.5+bus*1.5+car*1.2+motorbike*0.9
if timer>40:
	timer=40

sender = 'mayureshnehe@gmail.com'
receiver = args['username']

msg = MIMEMultipart()
msg['From'] = sender
msg['To'] = receiver
msg['Subject'] = 'AI TIMER'
msg.attach(MIMEText(str(timer)+' seconds', 'plain'))

server = smtplib.SMTP('smtp.gmail.com', 587)
server.starttls()
server.login(sender, 'ougfcvwqrpdowqcl')
text = msg.as_string()
